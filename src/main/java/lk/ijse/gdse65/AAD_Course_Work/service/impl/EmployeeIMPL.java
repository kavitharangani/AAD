...
//        EmployeeEntity savedEmployee = employeeDAO.save(mapping.toEmployeeEntity(employee));
//        return mapping.toEmployeeDTO(savedEmployee);
//    }
//
//    @Override
...
//    }
    ...
    public void saveEmployee(EmployeeDTO employeeDTO) {
        ...
        EmployeeEntity employeeEntity = mapping.convertToEmployeeEntity(Optional.of(employeeDTO));
        employeeDAO.save(employeeEntity);
    }

    private String getNextEmployeeCode() {
        EmployeeEntity firstByOrderByEmployeeIdDesc = employeeDAO.findFirstByOrderByEmployeeCodeDesc();
